...
public class Sale extends JFrame{
	...
	public Sale() {
		...
		Sale.allCart = new Object[Sale.allMenu][4];
		addCart.x = 0;
...
class addCart{
	...
	public addCart(Object name, Object condi, Object price, Object count) {
		...
		Sale.allCart[x][0]= name;
		Sale.allCart[x][1]= condi;
		Sale.allCart[x][2]= price;
		Sale.allCart[x][3]= count;

		x+=1;
		System.out.println(Arrays.deepToString(Sale.allCart));
	}
}
...
//				new CartDisplay("1234", Sale.allCart);
//				frame.dispose();
