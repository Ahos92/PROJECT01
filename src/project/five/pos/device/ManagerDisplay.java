...
import project.five.pos.device.action.InquiryAction;
...
public class ManagerDisplay extends JFrame {
	...
	public ManagerDisplay() {
		...
		pay_history.addActionListener(new InquiryAction(this));
		sold_history.addActionListener(new InquiryAction(this));
		mem_info.addActionListener(new InquiryAction(this));
