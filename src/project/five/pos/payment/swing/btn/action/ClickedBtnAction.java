...
public class ClickedBtnAction implements ActionListener{
	...
	public ClickedBtnAction(Container junior_panel, String payment_type, JButton card_btn, JButton cash_btn, int price) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btn.getText().equals("카드")) {
			...
			new PaidByCard(price, card_btn, cash_btn);
		}
			...
			new PaidByCash(price, card_btn, cash_btn);
		}
